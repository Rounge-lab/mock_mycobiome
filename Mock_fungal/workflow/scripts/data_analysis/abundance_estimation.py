...
cols={'kraken':'KrakenDetected_','eukdetect':'EukDetected_','metaphlan':'MetaphlanDetected_','HMS':'HMSDetected_'}
...
sb.boxplot(data=Report,x='Tool',y='RMSE',palette=['#6b519d','#ff66c4','#7ed957','#f4cbb0'],order=['kraken','metaphlan','HMS','eukdetect'],hue='Level')
