...
fig=sb.boxplot(data=compl,x='Tool',y='F1',hue='variable',palette=['#6b519d','#ff66c4','#7ed957','#f4cbb0'],order=['kraken','metaphlan','HMS','eukdetect'])
...
fig=sb.boxplot(data=Pearson,y='Tool',x='PearsonR',hue='Metric',palette=['#6b519d','#ff66c4','#7ed957','#f4cbb0'],order=['kraken','metaphlan','HMS','eukdetect'])
